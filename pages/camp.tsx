...
import Credentials from '../client/components/squeeze/credentials';
...
const useStyles = makeStyles(theme => ({
  header: {
    ...
    [theme.breakpoints.down('xs')]: {
      backgroundImage: 'url(/images/camp-mobile.png)',
      height: '75vw'
    },
    ...
    [theme.breakpoints.up('md')]: {
      backgroundImage: 'url(/images/camp.png)',
      paddingTop: '30%'
    }
  },
  upper: {
    ...
    >
      <header className={classes.header}>
        ...
        <div className={classes.lower}>
          <ClassListingCTA label="50% off on All Online Camps" />
        </div>
      </header>
      <Credentials />
      <MainSection
      ...
      <CustomerSays />
      <MainSection>
        <ClassListingCTA label="Check Out Online Camps" />
      </MainSection>
    </Layout>
  );
}
