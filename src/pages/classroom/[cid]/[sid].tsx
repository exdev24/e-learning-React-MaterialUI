...
import { IDVars, StudentIdVars } from '../../../types';

export default function ClassroomPage(props: { cid: string; sid: string }) {
  const result = useQuery<{ classroom: Classroom }, IDVars & StudentIdVars>(
    GetClassroomQuery,
    {
